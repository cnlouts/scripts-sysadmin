...
def do_create_user(first,last,pw,email)
  ...
  result = system("sudo /usr/sbin/useradd -G developers,www-data  -s /bin/bash -b /home/developers -m -p '#{ pwd }' #{ uname }")
    if result
      puts "#{ uname } created!"
      system("sudo /bin/chmod 0775 /home/developers/#{ uname }")
      system("sudo /bin/chgrp  developers /home/developers/#{ uname }")
...
print "Enter the FIRST name of the new developer: "
  first = gets.chomp.downcase
print "Enter the LAST name of the new developer: "
